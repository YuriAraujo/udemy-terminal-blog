...
def login_user():
    ...
    if User.validate_login(email=email, password=password):
...
def blog_posts(blog_id):
    ...
    render_template('posts.html', posts=posts, blog_title=blog.title, blog_id=blog._id)
